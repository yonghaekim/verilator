...
VL_INLINE_OPT void VTestHarness___024unit::__Vdpiimwrap_memory_init_TOP____024unit(const QData/*63:0*/ mem_size, const QData/*63:0*/ word_size, const QData/*63:0*/ line_size, const QData/*63:0*/ id_bits, QData/*63:0*/(&  memory_init__Vfuncrtn)) {
    ...
    void* memory_init__Vfuncrtn__Vcvt = memory_init(mem_size__Vcvt, word_size__Vcvt, line_size__Vcvt, id_bits__Vcvt);
...
VL_INLINE_OPT void VTestHarness___024unit::__Vdpiimwrap_memory_tick_TOP____024unit(const QData/*63:0*/ channel, const CData/*0:0*/ reset, const CData/*0:0*/ ar_valid, CData/*0:0*/(&  ar_ready), const IData/*31:0*/ ar_addr, const IData/*31:0*/ ar_id, const IData/*31:0*/ ar_size, const IData/*31:0*/ ar_len, const CData/*0:0*/ aw_valid, CData/*0:0*/(&  aw_ready), const IData/*31:0*/ aw_addr, const IData/*31:0*/ aw_id, const IData/*31:0*/ aw_size, const IData/*31:0*/ aw_len, const CData/*0:0*/ w_valid, CData/*0:0*/(&  w_ready), const IData/*31:0*/ w_strb, const QData/*63:0*/ w_data, const CData/*0:0*/ w_last, CData/*0:0*/(&  r_valid), const CData/*0:0*/ r_ready, IData/*31:0*/(&  r_id), IData/*31:0*/(&  r_resp), QData/*63:0*/(&  r_data), CData/*0:0*/(&  r_last), CData/*0:0*/(&  b_valid), const CData/*0:0*/ b_ready, IData/*31:0*/(&  b_id), IData/*31:0*/(&  b_resp)) {
    ...
    unsigned char reset__Vcvt;
    reset__Vcvt = reset;
    unsigned char ar_valid__Vcvt;
    ar_valid__Vcvt = ar_valid;
    unsigned char ar_ready__Vcvt;
    int ar_addr__Vcvt;
    ...
    int ar_len__Vcvt;
    ar_len__Vcvt = ar_len;
    unsigned char aw_valid__Vcvt;
    aw_valid__Vcvt = aw_valid;
    unsigned char aw_ready__Vcvt;
    int aw_addr__Vcvt;
    ...
    int aw_len__Vcvt;
    aw_len__Vcvt = aw_len;
    unsigned char w_valid__Vcvt;
    w_valid__Vcvt = w_valid;
    unsigned char w_ready__Vcvt;
    int w_strb__Vcvt;
    w_strb__Vcvt = w_strb;
    long long w_data__Vcvt;
    w_data__Vcvt = w_data;
    unsigned char w_last__Vcvt;
    w_last__Vcvt = w_last;
    unsigned char r_valid__Vcvt;
    unsigned char r_ready__Vcvt;
    r_ready__Vcvt = r_ready;
    int r_id__Vcvt;
    int r_resp__Vcvt;
    long long r_data__Vcvt;
    unsigned char r_last__Vcvt;
    unsigned char b_valid__Vcvt;
    unsigned char b_ready__Vcvt;
